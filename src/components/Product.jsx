...
export default function Product({id,category,description,image,price,rating,title, item, onProductClick}) {
  return (
    <div className="w-[140px] p-2 flex flex-col" onClick={()=>{onProductClick(item)}}>
